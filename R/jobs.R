...
FolderCF = "/Complete-Chains-HPML/config-files-apptainer"
    ...
    while(f<=length(Dendrogram.1)){
      ...
      while(w<=length(Criteria.1)){
        ...
        while(d<=nrow(datasets)){
          ...
          write("echo =============================================================", 
                file = output.file, append = TRUE)
          str.5 = paste("echo SBATCH: RUNNING COMPLETE CHAINS HPML FOR ", 
                        ds$Name, sep="")
          ...
          str.30 = paste("cp /home/u704616/Experimentos-8.sif ", scratch.name, sep ="")
          ...
          str = paste("singularity instance start --bind ~/.config/rclone/:/root/.config/rclone ", 
                      scratch.name, "/Experimentos-8.sif EXPCo", a, sep="")
          write(str, file = output.file, append = TRUE)
          ...
          str = paste("singularity run --app Rscript instance://EXPCo",
                      a, " /Complete-Chains-HPML/R/complete.R \"/Complete-Chains-HPML/config-files-apptainer/",
          ...
          str = paste("singularity instance stop EXPCo", a, sep="")
          write(str, file = output.file, append = TRUE)
